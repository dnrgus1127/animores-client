...
const PetListModal = (props: any) => {
  ...
  const { petList, isLoading: isPetListLoading } = usePetList();
              ...
              <Pressable key={pet.id} onPress={() => togglePetsIdsFunction(pet.id)}>
                <View style={styles.petRowContainer}>
                  <View style={{ flexDirection: 'row' }}>
                    <Image source={{ uri: IMAGE_BASE_URL + pet.imageUrl }} style={{ width: 50, height: 50, marginRight: 20 }} />
